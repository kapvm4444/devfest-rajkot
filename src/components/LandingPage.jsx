        ...
        <div className="min-h-screen flex items-center justify-center px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="space-y-6 max-w-md mx-auto relative z-30 pointer-events-auto">
              ...
              <Link
                to="/badge"
                className="group block w-full bg-gradient-to-r text-black bg-white border-black border-2 font-bold py-6 px-8 rounded-full transition-all duration-300 transform hover:scale-105 hover:shadow-2xl font-google-sans relative z-40"
              >
